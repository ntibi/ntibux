...
OBJS = boot.o kernel.o misc.o kmisc.o terminal.o terminal_printk.o vga.o interpreter.o gdt.o mem.o list.o debug.o idt.o interrupt_handlers.o interrupts.o timer.o scheduler.o asm_misc.o spinlock.o cpus.o
